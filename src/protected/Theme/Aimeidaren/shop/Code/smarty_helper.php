...
function smarty_helper_function_get_asset_url(array $paramArray, $smarty)
{
    ...
    return \Core\Asset\ManagerHelper::getAssetUrl(
        \Theme\Aimeidaren\ShopThemePlugin::pluginGetUniqueId(),
        $paramArray['asset']
    );
}
...
function smarty_helper_function_get_option_value(array $paramArray, $smarty)
{
    ...
    return \Theme\Aimeidaren\ShopThemePlugin::getOptionValue($paramArray['optionKey']);
}
...
{
    return \Theme\Aimeidaren\ShopThemePlugin::getOptionValue($optionKey);
}
...
function smarty_helper_function_assign_option_value(array $paramArray, $smarty)
{
    ...
    $optionValue = \Theme\Aimeidaren\ShopThemePlugin::getOptionValue($optionKey);
