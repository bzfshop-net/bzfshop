...
<script type="text/javascript">
    ...
    var WEB_COOKIE_AUTH_KEY = '{{$WEB_COOKIE_AUTH_KEY|default}}';
</script>

<script type="text/javascript"
        src="{{bzf_get_asset_url asset='bootstrap-custom/kindeditor/kindeditor-min.js'}}"></script>
<script type="text/javascript" src="{{bzf_get_asset_url asset='bootstrap-custom/kindeditor/lang/zh_CN.js'}}"></script>
