...
namespace Plugin\Payment\AlipayWap {
    ...
    class AlipayWapPlugin extends AbstractBasePlugin
    {
        // 使用 UUID 作为插件的唯一 ID
        protected static $pluginUniqueId = '2209B80B-AA57-4646-B63B-6DFFD5213316';
        ...
        public function pluginGetConfigureUrl($system)
        {
            ...
            if (PluginHelper::SYSTEM_MANAGE === $system) {
                return RouteHelper::makeUrl('/Payment/AlipayWap/Configure');
            }
        ...
        private function doManageAction()
        {
            ...
            SystemHelper::addRouteMap(
                '/Payment/AlipayWap/Configure',
                'Controller\Payment\AlipayWap\Configure'
            );
        ...
        private function doMobileAction()
        {
            ...
            SystemHelper::addAutoloadPath($currentPluginBasePath . '/mobile/Code');

            // 注册一种支付方式
            PaymentGatewayHelper::registerInstanceKeyClass('alipaywap', '\Payment\AlipayWap\Gateway');
...
namespace {
    // 返回 plugin instance
    return Plugin\Payment\AlipayWap\AlipayWapPlugin::instance();
}
