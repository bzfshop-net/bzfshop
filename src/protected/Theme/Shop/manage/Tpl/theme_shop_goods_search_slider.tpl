...
{{block name=theme_shop_main_body}}
    ...
    <script type="text/javascript">
        window.bz_set_nav_status.push(function ($) {
            $("#theme_shop_tabbar li:has(a[href='{{bzf_make_url controller='/Theme/Shop/GoodsSearchSlider'}}'])").addClass("active");
        });
        ...
        <div id="theme_shop_slider_image_container_clone" class="row theme_shop_slider_image_container">
            <div class="span10 theme_shop_goods_search_slider_image_wrapper">
                <a target="_blank" href="#">
                    <img src="{{theme_shop_get_asset_url asset='img/placeholder_1000x250.gif'}}"/>
                </a>
                <input type="hidden" name="image[]"
                       value="{{theme_shop_get_asset_url asset='img/placeholder_1000x250.gif'}}"/>
