...
class SrcDataMapper extends \Core\Modal\SqlMapper
{
    ...
    public static function getDbEngine()
    {
        ...
        if (null == static::$dbEngine) {
            ...
            global $f3;
            // 初始化全站数据库
            static::$tablePrefix = $f3->get('sysConfig[src_db_table_prefix]');
            static::$dbEngine    = new \Core\Modal\DbEngine($f3->get('sysConfig[src_db_pdo]'),
