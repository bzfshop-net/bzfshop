...
namespace Plugin\Payment\Tenpay {
    ...
    class TenpayPlugin extends AbstractBasePlugin
    {
        // 使用 UUID 作为插件的唯一 ID
        protected static $pluginUniqueId = '585CB626-AC0F-4801-8597-C7065CC1F48B';
        ...
        public function pluginGetConfigureUrl($system)
        {
            ...
            if (PluginHelper::SYSTEM_MANAGE === $system) {
                return RouteHelper::makeUrl('/Payment/Tenpay/Configure');
            }
        ...
        private function doManageAction()
        {
            ...
            SystemHelper::addRouteMap(
                '/Payment/Tenpay/Configure',
                'Controller\Payment\Tenpay\Configure'
            );
        ...
        private function doShopAction()
        {
            ...
            // 注册一种支付方式
            PaymentGatewayHelper::registerInstanceKeyClass('tenpay', '\Payment\Tenpay\Gateway');
...
namespace {
    // 返回 plugin instance
    return Plugin\Payment\Tenpay\TenpayPlugin::instance();
}
