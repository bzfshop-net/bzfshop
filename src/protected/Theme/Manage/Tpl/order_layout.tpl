...
{{block name=main_body}}
    ...
    <script type="text/javascript">
        window.bz_set_nav_status.push(function ($) {
            $("#system_top_navbar li:has(a[href='{{bzf_make_url controller='/Order/Index'}}'])").addClass("active");
        });
    </script>
    <div class="row bz_basic_content_block bz_box_shadow" style="padding:10px 10px 10px 10px;">
        ...
        <div id="order_tabbar" class="row">
            <ul class="nav nav-tabs">
                <li><a href="{{bzf_make_url controller='/Order/Order/Search'}}">订单列表</a></li>
                ...
                <li><a href="{{bzf_make_url controller='/Order/Statistics/ListGoods'}}">销售排行</a></li>
                <li><a href="{{bzf_make_url controller='/Order/Settle'}}">订单结算</a></li>
